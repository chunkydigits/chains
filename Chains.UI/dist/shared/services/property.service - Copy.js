...
var PropertyService = (function () {
    ...
    PropertyService.prototype.getPropertiesForUserId = function (id) {
        return propertyItems;
    };
    PropertyService.prototype.getPropertyById = function (id) {
        console.log('id received by service: ' + id);
        return propertyItems.find(function (propertyInfo) { return propertyInfo.id === id; });
    };
    ...
    PropertyService.prototype.getNewProperty = function () {
        return new property_1.PropertyInformation();
    };
...
//# sourceMappingURL=property.service - Copy.js.map